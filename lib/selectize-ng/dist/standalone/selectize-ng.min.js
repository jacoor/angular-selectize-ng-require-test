...
function(a, b) {
    ...
    return e.mixin(J), c.mixin(J), a.extend(J.prototype, {
        ...
        deleteSelection: function(b) {
            ...
            } else(l.isFocused || "single" === l.settings.mode) && l.items.length && (0 > e && 0 === f.start && 0 === f.length ? g.push(l.items[l.caretPos - 1]) : e > 0 && f.start === l.$control_input.val().length && g.push(l.items[l.caretPos])); if (!g.length || "function" == typeof l.settings.onDelete && l.settings.onDelete.apply(l, [g]) === !1) return !1;
...
angular.module("selectize-ng", []).directive("selectize", function() {
    ...
    return {
        ...
        link: function(a, b, c, d) {
            function e(b) {
                m || (a.$parent.$apply(function() {
                    d.$setViewValue(b)
                }), "single" === n.mode && o.blur())
            }

            function f(a) {
                return angular.isArray(a) ? a : a ? String(a).split(n.delimiter) : []
            }
            ...
            function i(a, b) {
                a.map(function(a) {
                    h(b, a) || h(p, a) || p.push(a)
                })
            }

            function j(a, b) {
                var c, d;
                for (c = 0; c < a.length; c++) d = g(p, a[c][o.settings.valueField]), -1 !== d && (b.push(a[c][o.settings.valueField]), p.splice(d, 1))
            }

            function k(a) {
                var b = f(a);
                m || b === f(o.getValue()) || (m = !0, setTimeout(function() {
                    o.setValue(b), m = !1, i(b, f(o.getValue()))
                }))
            }

            function l(a) {
                var b = f(d.$viewValue);
                o.addOption(a), o.refreshOptions(!1), "multi" === n.mode && a && j(a, b), k(b)
            }
            var m, n, o, p = [];
            n = angular.extend({
                delimiter: ",",
                persist: !0,
                mode: "SELECT" === b[0].tagName ? "single" : "multi"
            }, a.selectize() || {}), o = b.selectize(n)[0].selectize, o.on("change", function() {
                e(o.getValue())
            }), a.$parent.$watch(c.ngModel, k), c.options && a.$parent.$watchCollection(c.options, l), a.$on("$destroy", function() {
                o.destroy()
            })
        }
    }
